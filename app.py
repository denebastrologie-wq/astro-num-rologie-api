...
def generer_semaines_numerologiques(cvh1, cvh2, cvh3):
    """
    Génère 4 semaines avec progression numérologique
    Chaque semaine = 3 périodes (CVH modifiés)
    """
    semaines = []
    
    for i in range(4):
        # Variation progressive basée sur la semaine
        variation = i + 1
        
        periode1 = reduire_a_22(cvh1 + variation)
        periode2 = reduire_a_22(cvh2 + variation)
        periode3 = reduire_a_22(cvh3 + variation)
        ...
        semaines.append({
            ...
            "periode2": periode2,
            "periode3": periode3,
            "arc_debut": i * 28,  # Chaque période = 28 degrés
            "arc_fin": (i + 1) * 28
        })
...
def calcul_complet():
    ...
    try:
        ...
        semaines = generer_semaines_numerologiques(cvh1, cvh2, cvh3)
